...
// This models the buffer with a double-linked list.
//
// --------------------------------------------------------------------------
...
private:
    ...
    // contains a character and a pointer to the next  and previous cells in
    // the chain.  To simplifiy the code used to maintain the cursor, this
    // implementation adds an extra "dummy" cell at the beginning of the list.
    // The character in this cell is not used, but having it in the data
    // structure provides a cell for the cursor to point to when the cursor is
    ...
    // character and a pointer to the next and prevous cells in the chain.
