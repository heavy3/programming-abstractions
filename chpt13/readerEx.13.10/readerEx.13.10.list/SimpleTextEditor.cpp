...
// Chapter 13, Exercise 10 (list-based)
...
const std::string HEADER = "CS106B Programming Abstractions in C++: Ex 13.10\n";
const std::string DETAIL = "List-based editor with replace feature. H for help.";
