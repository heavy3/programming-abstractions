...
// Method: getText
// Usage: string mystr = cstk.getText(RIGHT, cstk.size(RIGHT));
// ------------------------------------------------------------
...
// though the underlying array is not actually popped.  This order may be
// reversed as desired.

    std::string getText(const WhichStack stack, const int n,
