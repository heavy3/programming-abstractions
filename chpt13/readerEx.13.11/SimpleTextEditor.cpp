...
//
// This version of SimpleTextEditor aligns with the version from 13.10 but
// depends upon an updated buffer class implementation which does /not/ 
// use a dummy cell strategy for managing the linked list.  Instead, 
// cursor positions at the beginning of the buffer are designated as NULL.
//
// --------------------------------------------------------------------------
// Attribution: "Programming Abstractions in C++" by Eric Roberts
// Chapter 13, Exercise 11 (list-based)
...
// --------------------------------------------------------------------------
//
// Created by Glenn Streiff on 8/19/16.
...
const std::string HEADER = "CS106B Programming Abstractions in C++: Ex 13.11\n";
const std::string DETAIL = "List-based editor without dummy cell. H for help.";
