...
// Sierpinski.cpp
//
// This program renders a Sierpinski triangle.  The user is prompted to
// enter the edge length and Sierpinski order.
//
// --------------------------------------------------------------------------
// Assignment: 3, Part 2 Sierpinski Triangle
...
const string HEADER = "CS106B Programming Abstractions: Assignment 3.2\n";
