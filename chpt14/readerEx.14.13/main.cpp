...
// extended precision class call BigInt which uses a linked-list for the
// underlying representation of a number.
//
// For example:
//
...
void makeFactorialTable(int maxN);

// Main program

int main() {
    cout << BANNER << endl << endl;
    makeFactorialTable(MAX_N);
    return 0;
}

// Function: makeFactorialTable
// Usage: makeFactorialTable(52);
// ------------------------------
// Will produce a table of factorials of n from 0 to a specified max n.
...
void makeFactorialTable(int maxN) {
    ...
    // Use extended precision operands and operator to avoid overflow.
