...
const std::string HEADER = "CS106B Programming Abstractions in C++: Ex 13.07\n";
const std::string DETAIL = "Stack-based editor with copy & paste. H for help.";
...
void printHelpText() {
    ...
    cout << "  #|{F|B|D|C}  Perform the command # times" << endl;
    cout << "  #|W{F|B|D|C}  Perform the command # times on W boundaries" << endl;
