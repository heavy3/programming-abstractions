...
// bufferUnitTest.cpp
//
// This program is a unit test driver for the EditorBuffer class.
//
// --------------------------------------------------------------------------
...
// --------------------------------------------------------------------------
//
// Created by Glenn Streiff on 7/26/16.
...
const std::string HEADER = "CS106B Programming Abstractions in C++: Ex 13.01\n";
const std::string DETAIL = "Unit Test EditorBuffer class.";
