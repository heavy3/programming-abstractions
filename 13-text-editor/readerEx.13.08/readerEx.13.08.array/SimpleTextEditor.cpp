...
// --------------------------------------------------------------------------
//
// Created by Glenn Streiff on 8/04/16.
...
const std::string HEADER = "CS106B Programming Abstractions in C++: Ex 13.08\n";
const std::string DETAIL = "Array-based editor with cut feature. H for help.";
