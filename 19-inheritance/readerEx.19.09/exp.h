...
public:
	...
	// ----------------------------------------
    // Returns true if a given variable name is in the symbol table.

	bool isDefined(std::string var);
    
    // Method: getVariables
    // Usage: Set<std::string> varNames = context.getVariables();
    // ----------------------------------------------------------
    // Returns a set of symbol names from the symbol table.
    // We're using a set to satisfy a lexigraphical ordering requirement.
    
    Set<std::string> getVariables();
