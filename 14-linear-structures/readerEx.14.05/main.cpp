...
// main.cpp
//
// This file contains a unit test of two different queue implementations
...
const std::string HEADER = "CS106B Programming Abstractions in C++: Ex 14.05\n";
const std::string DETAIL = "Unit test driver for two queue implementations.";
