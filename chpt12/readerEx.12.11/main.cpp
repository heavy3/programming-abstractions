...
// Copyright © 2015, 2016 Glenn Streiff. All rights reserved.
//
...
const std::string HEADER = "CS106B Programming Abstractions in C++: Ex 12.11\n";
const std::string DETAIL = "MyString Class with Unit Test";
